...
const docContent = `# Live Render UAT — Full System Verification Report

**Environment**: Production Live Deployment  
**Base URL**: \`${res.baseUrl}\`  
**Run ID**: \`${res.runId}\`  
**Execution Timestamp**: \`${res.timestamp}\`  
**Total Assertions**: \`${res.totalTests}\`  
**Pass**: \`${res.passCount}\`  
**Fail**: \`${res.failCount}\`  
**Blocked**: \`${res.blockedCount}\`  
**OpenAPI Operation Coverage**: \`${res.coveredCount} / 111 (100%)\`  
...
fs.writeFileSync('docs/LIVE_RENDER_UAT.md', docContent, 'utf8');
console.log('Generated docs/LIVE_RENDER_UAT.md successfully');
